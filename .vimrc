...
"            ----------------------------------
"
nnoremap Ë :lnext<cr>zvzz
nnoremap ÂŹ :lprevious<cr>zvzz
inoremap Ë <esc>:lnext<cr>zvzz
inoremap ÂŹ <esc>:lprevious<cr>zvzz
...
function! MyFoldText() " {{{
    ...
    return line . 'âŚ' . repeat(" ",fillcharcount) . foldedlinecount . 'âŚ' . ' '
endfunction " }}}
...
augroup ft_html
    ...
    au FileType html,jinja,htmldjango nnoremap <buffer> P :<C-U>YRPaste 'P'<CR>v`]=`]
    au FileType html,jinja,htmldjango nnoremap <buffer> Ď :<C-U>YRPaste 'p'<CR>
    au FileType html,jinja,htmldjango nnoremap <buffer> â :<C-U>YRPaste 'P'<CR>
